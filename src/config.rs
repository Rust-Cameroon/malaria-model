...
pub struct ModelConfig {
    ...
    pub fc2_units: usize,
    /// Number of species classes (4: Falciparum/Malariae/Ovale/Vivax)
    ...
    /// Path to manifest CSV generated by mpidb_prep
...
impl Default for ModelConfig {
    fn default() -> Self {
        Self {
            ...
            grad_accum_steps: 1,
            manifest_path: "mpidb_crops/manifest.csv".to_string(),
        }
    }
}